...
<div class="btn-group w-100">
  ...
  <button class="btn btn-outline-secondary"  onclick="document.execCommand('bold',false,null);">
  ...
  <button class="btn btn-outline-secondary"  onclick="document.execCommand('italic',false,null);">
  ...
  <button class="btn btn-outline-secondary" onclick="document.execCommand('underline',false,null);">
  ...
  <button class="btn btn-outline-secondary" onclick="document.execCommand('strikethrough',false,null);">
  ...
  {#if buttons.includes('ul')}
  <button class="btn btn-outline-secondary" onclick="document.execCommand('InsertUnorderedList',false,null);">
  ...
  {#if buttons.includes('ol')}
  <button class="btn btn-outline-secondary" onclick="document.execCommand('InsertOrderedList',false,null);">
  ...
  <button class="btn btn-outline-secondary" on:click="{insertLink}">
...
<div class="tiny-editor mb-3" contenteditable="true" bind:innerHTML={value}></div>
...
.tiny-editor:focus{
  border-color: #9DCBFB;
  box-shadow: 0 2px 2px #9DCBFB inset, 0 0 4px #9DCBFB;
  outline: 0 none;
}
